...
export const SHOW_COMPLETED_TASKS = document.querySelector("#completed");
export const SHOW_UNCOMPLETED_TASKS = document.querySelector("#uncompleted");
export const CLEAR_ALL_TASKS= document.querySelector("#clear");
